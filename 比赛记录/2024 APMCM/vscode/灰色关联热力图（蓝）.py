...
# 将结果转换为适合热力图的数据格式
heatmap_data = gray_relation_results.set_index("变量")

# 绘制热力图
plt.figure(figsize=(12, 8))
sns.heatmap(heatmap_data, annot=True, fmt=".2f", cmap="YlGnBu", linewidths=0.5, cbar_kws={'label': '灰色关联度'})
plt.title("灰色关联度热力图", fontsize=16)
plt.xlabel("因变量", fontsize=14)
plt.ylabel("自变量", fontsize=14)
