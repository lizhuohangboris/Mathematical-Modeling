...
results.to_excel(r"D:\Normal_tools\Github_desktop\Clone_shop\Mathematical-Modeling\比赛记录\2025 MCM\校赛\数据集\改进随机森林预测结果.xlsx", index=False)
print("\n预测结果已保存至 '改进随机森林预测结果.xlsx'")
