...
# 9. 变量重要性
importance = xgb_model.feature_importances_  # 提取特征重要性
feature_importance = pd.DataFrame({'Feature': ['elevation', 'bio1', 'bio12', 'bare land', 'road', 
                                                'grassland', 'tree', 'wood', 'shelter'], 
...
results.to_excel(r"D:\Normal_tools\Github_desktop\Clone_shop\Mathematical-Modeling\比赛记录\2025 MCM\校赛\数据集\XGBoost预测结果.xlsx", index=False)
print("\n预测结果已保存至 'XGBoost预测结果.xlsx'")
