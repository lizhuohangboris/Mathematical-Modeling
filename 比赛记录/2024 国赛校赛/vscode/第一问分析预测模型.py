...
# plt.plot(dates[:len(y_test)], y_test_original, label='Actual (Test)', color='blue', linestyle='-')
# plt.plot(dates[:len(y_pred)], y_pred_original, label='Predicted (Test)', color='orange', linestyle='--')
# plt.plot(dates[:len(y_train)], y_train, label='Actual (Train)', color='green', linestyle='-')
