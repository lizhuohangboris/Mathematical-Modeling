...
output_excel_path = "C:/Users/92579/Documents/GitHub/Mathematical-Modeling/比赛记录/2024 MCM/美赛/2024_MCM-ICM_Problems/2024_MCM-ICM_Problems/第二问.xlsx"

# Add the 'xg_probabilities' column to the DataFrame
df['xg_probabilities'] = xg_model.predict_proba(df[features_xg])[:, 1]

# Save the DataFrame with the 'xg_probabilities' column to the Excel file
df[['xg_probabilities']].to_excel(output_excel_path, index=False, header=False, startcol=0)
